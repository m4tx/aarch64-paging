...
impl<T: Translation<R::Attributes>, R: TranslationRegime> Mapping<T, R> {
    ...
    pub fn new(
        ...
        if !R::supports_asid() && asid != 0 {
            panic!("{:?} doesn't support ASID, must be 0.", regime);
        }
        Self {
...
mod tests {
    ...
    use super::*;
    #[cfg(feature = "alloc")]
    use crate::descriptor::{El2Attributes, El3Attributes};
    #[cfg(feature = "alloc")]
    use crate::paging::{El2, El3};

    #[cfg(feature = "alloc")]
    #[test]
    #[should_panic]
    fn no_el2_asid() {
        Mapping::<IdTranslation<El2Attributes>, El2>::new(
            IdTranslation::new(),
            1,
            1,
            El2,
    ...
    #[should_panic]
    fn no_el3_asid() {
        Mapping::<IdTranslation<El3Attributes>, El3>::new(
            IdTranslation::new(),
            1,
            1,
            El3,
